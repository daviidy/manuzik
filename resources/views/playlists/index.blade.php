...
<div id="addPlaylistModal" class="modal fade hidden relative z-10" aria-labelledby="modal-title" role="dialog"
            aria-modal="true">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>

            <div class="fixed inset-0 z-10 overflow-y-auto">
                <div id="addPlaylistModalPanel"
                    ...
                    <div
                        ...
                        <form method="post" action="{{ route('playlists.update', ['playlist' => $playlist->id]) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="space-y-12">
                                <div class="border-b border-gray-900/10 pb-12">
                                    <h2 class="text-base font-semibold leading-7 text-gray-900">Modifier une playlist
                                    </h2>
                                    <p class="mt-1 text-sm leading-6 text-gray-600">Modifier une playlist</p>
